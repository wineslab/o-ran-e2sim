...
static asn_oer_constraints_t asn_OER_type_list_of_matched_UEs_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..65535)) */};
static asn_per_constraints_t asn_PER_type_list_of_matched_UEs_constr_5 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
static asn_oer_constraints_t asn_OER_memb_list_of_matched_UEs_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..65535)) */};
static asn_per_constraints_t asn_PER_memb_list_of_matched_UEs_constr_5 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 16,  16,  1,  65535 }	/* (SIZE(1..65535)) */,
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_list_of_matched_UEs_5[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
static const ber_tlv_tag_t asn_DEF_list_of_matched_UEs_tags_5[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_list_of_matched_UEs_specs_5 = {
...
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_list_of_matched_UEs_5 = {
	"list-of-matched-UEs",
	"list-of-matched-UEs",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_list_of_matched_UEs_tags_5,
	sizeof(asn_DEF_list_of_matched_UEs_tags_5)
		/sizeof(asn_DEF_list_of_matched_UEs_tags_5[0]) - 1, /* 1 */
	asn_DEF_list_of_matched_UEs_tags_5,	/* Same as above */
	sizeof(asn_DEF_list_of_matched_UEs_tags_5)
		/sizeof(asn_DEF_list_of_matched_UEs_tags_5[0]), /* 2 */
	{ &asn_OER_type_list_of_matched_UEs_constr_5, &asn_PER_type_list_of_matched_UEs_constr_5, SEQUENCE_OF_constraint },
	asn_MBR_list_of_matched_UEs_5,
	1,	/* Single element */
	&asn_SPC_list_of_matched_UEs_specs_5	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_E2SM_KPM_IndicationMessage_Format1_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct E2SM_KPM_IndicationMessage_Format1, list_of_matched_UEs),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_list_of_matched_UEs_5,
		0,
		{ &asn_OER_memb_list_of_matched_UEs_constr_5, &asn_PER_memb_list_of_matched_UEs_constr_5,  memb_list_of_matched_UEs_constraint_1 },
		0, 0, /* No default value */
		"list-of-matched-UEs"
		},
};
static const int asn_MAP_E2SM_KPM_IndicationMessage_Format1_oms_1[] = { 2 };
...
static const asn_TYPE_tag2member_t asn_MAP_E2SM_KPM_IndicationMessage_Format1_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* list-of-matched-UEs */
};
